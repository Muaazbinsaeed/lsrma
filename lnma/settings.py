...
# Toxixcity Groups abbr dcitionary 

TOXIXITY_ABBR_GROUP ={
    'treatment': 'Treatment related adverse events',
    'immune': 'Immune related adverse events',
    'all_adverse': 'All cause adverse events'
}
...
INPUT_FORMAT_TPL = {
    ...
    "pwma": {
        ...
        "PRIM_CAT_PRE": [{
            ...
            {
                'abbr': 'survival_in_treatment',
                'name': 'Survival in Treatment',
                'subs': None,
            }, {
