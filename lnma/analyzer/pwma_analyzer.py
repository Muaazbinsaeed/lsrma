...
from .rpadapter import _meta_trans_metabin_subg
from .rpadapter import _meta_trans_metagen_subg
...
def analyze(rs, cfg):
    ...
    if cfg['input_format'] == 'PRIM_CAT_PRE':
        ...
        # 2023-09-22: fix the pwma subg analyzer bug
        ret['data'] = {
            'primma': _meta_trans_metabin(jrst, params)
        }

    elif cfg['input_format'] == 'SUBG_CAT_PRE':
        # 2023-09-22: fix the pwma subg analyzer bug
        ret['data'] = {
            'primma': _meta_trans_metagen_subg(jrst, params)
        }

    elif cfg['input_format'] == 'SUBG_CAT_RAW':
        # 2023-09-22: fix the pwma subg analyzer bug
        ret['data'] = {
            'primma': _meta_trans_metabin_subg(jrst, params)
        }
