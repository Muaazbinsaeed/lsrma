...
def import_by_doi(project_id, doi, rct_id=None):
    '''
    Import a study by its DOI
    '''
    # try to search this doi
    doi = doi.lower()
    data, raw_data, msg = util.doi_fetch(doi)
    ...
    if paper is None:
        ...
        # it's OK ... just update information
        pass

    # update the paper information
    paper.from_doi_record(data)
