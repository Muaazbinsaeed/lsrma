    ...
    return {
        ...
        layout: {
            PRIM_CAT_RAW: [
                ...
                {width: 150,  align: 'end',    name: 'Trial Name', row: 2},
        ...
        draw: function(ext, data, cfg, pidList, NctList) {
            $(this.box_id).show();
            ...
            // show studies
            this._draw_study_vals(pidList, NctList);
        ...
        _draw_header: function() {
            if (this.is_input_format_cat_raw()) {
                this.svg.append('text')
                    ...
                    .text(this.ext.meta.treatments[0]);
                ...
                this.svg.append('text')
                    ...
                    .attr('y', this.row_height)
                    .attr('text-anchor', "end")
                    .text(this.ext.meta.treatments[1]);
            } else {
            ...
            for (var i = 0; i < this.data.stus.length; i++) {
                ...
                for (var j = 0; j < this.cols.length; j++) {
                    ...
                    if(col.name == 'Trial Name') {
                        const nct = pid_dict[stu.pid];
                        const trialName = nct_dict[nct];
                        _txt = trialName;
                    }
        ...
        _draw_forest: function() {
            ...
            this.svg.append('g')
                .attr('transform', 'translate('+(this.cols[8].x + this.row_frstml)+', '+(this.row_height * (6 + this.data.stus.length))+')')
                .call(this.xAxis);
    
            // draw the middle line
            var g_forest = this.svg.append('g')
                .attr('transform', 'translate('+(this.cols[8].x + this.row_frstml)+', 0)');
            ...
            this.svg.selectAll('g.prim-frst-stu-item')
                ...
                .attr('transform', (function(fig){
                    return function(d, i) {
                        var trans_x = fig.cols[8].x + fig.row_frstml;
            ...
            this.svg.append('g')
                .attr('transform', 'translate('+(this.cols[8].x + this.row_frstml)+', '+(this.row_height * (4 + this.data.stus.length))+')')
                .append('path')
                .attr('d', path_d)
        ...
        _draw_favours: function() {
            ...
            var loc = this.data.stus.length + 
                      ...
                      0.1; // the offset
            // create a region
            var gx = this.cols[8].x + this.row_frstml;
        ...
        get_txt_by_col: function(obj, idx) {
            switch(idx) {
                ...
                case 1: return '';
                case 2: return obj.Et;
                case 3: return obj.Nt;
                case 4: return obj.Ec;
                case 5: return obj.Nc;
                case 6: return obj.bt_TE.toFixed(2);
                case 7: return '['+obj.bt_lower.toFixed(2)+'; '+obj.bt_upper.toFixed(2)+']';
    
                // case 8 is the figure, so no text
                case 8: return ''; 
                case 9: 
