...
Object.assign(jarvis, {
     ...
     */
     ...
     compare_oc_names_category_outcome: function(a, b) {
        var fn_attr = '';
        var fn_a = null;
        var fn_b = null;
        if (a.hasOwnProperty('oc_category_outcome')) {
            fn_attr = 'oc_category_outcome';
            fn_a = a[fn_attr].toLocaleLowerCase();
            fn_b = b[fn_attr].toLocaleLowerCase();

        } else if (a.hasOwnProperty('oc_category_outcome')) {
            fn_attr = 'oc_category_outcome';
            fn_a = a[fn_attr].toLocaleLowerCase();
            fn_b = b[fn_attr].toLocaleLowerCase();
    ...
    compare_oc_names: function(a, b) {
        ...
        } else if (a.hasOwnProperty('oc_fullname')) {
            fn_attr = 'oc_fullname';
            fn_a = a[fn_attr].toLocaleLowerCase();
            fn_b = b[fn_attr].toLocaleLowerCase();
