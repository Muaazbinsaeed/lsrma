...
var srv_extractor = {
    ...
    url: {
        ...
        upload_xls_files_itable: "[[ url_for('extractor.upload_xls_files_itable') ]]",
        check_xls_files_itable: "[[ url_for('extractor.check_xls_files_itable') ]]",

        check_xls_files_result_table: "[[ url_for('extractor.check_xls_files_result_table') ]]",
        upload_xls_files_pwma: "[[ url_for('extractor.upload_xls_files_pwma') ]]",
        check_xls_files_pwma: "[[ url_for('extractor.check_xls_files_pwma') ]]",
        check_xls_files_nma: "[[ url_for('extractor.check_xls_files_nma') ]]",
        upload_xls_files_nma: "[[ url_for('extractor.upload_xls_files_nma') ]]",
        upload_xls_result_table: "[[ url_for('extractor.upload_xls_result_table')]]"
    },
    ...
    upload_xls_files_itable: function(
        form_data, callback) {
        $.ajax({
            type: 'POST',
            url: this.url.upload_xls_files_itable,
            data: form_data,
            contentType: false,
            cache: false,
            processData: false,
            success: callback,
            error: function(jqXHR, textStatus, errorThrown) {
                jarvis.toast('Something wrong when uploading files', 'alert');
                console.error(textStatus, errorThrown);
            }
        });
    },
    
    check_xls_files_itable: function(
        form_data, callback) {
        $.ajax({
            type: 'POST',
            url: this.url.check_xls_files_itable,
            data: form_data,
            contentType: false,
            cache: false,
            processData: false,
    ...
    check_xls_files_result_table: function(
        form_data, callback) {
        $.ajax({
            type: 'POST',
            url: this.url.check_xls_files_result_table,
            data: form_data,
            contentType: false,
            cache: false,
            processData: false,
    ...
    upload_xls_files_pwma: function(
        form_data, callback) {
        $.ajax({
            type: 'POST',
            url: this.url.upload_xls_files_pwma,
            data: form_data,
            contentType: false,
            cache: false,
            processData: false,
    ...
    check_xls_files_pwma: function(form_data, callback){

         $.ajax({
            type: 'POST',
            url: this.url.check_xls_files_pwma,
            data: form_data,
            contentType: false,
            cache: false,
            processData: false,
    ...
    check_xls_files_nma: function(form_data, callback){

        $.ajax({
           type: 'POST',
           url: this.url.check_xls_files_nma,
           data: form_data,
           contentType: false,
           cache: false,
           processData: false,
    ...
    upload_xls_files_nma: function(
        form_data, callback) {
        $.ajax({
            type: 'POST',
            url: this.url.upload_xls_files_nma,
            data: form_data,
            contentType: false,
            cache: false,
            processData: false,
    ...
    upload_xls_result_table : function(
        form_data, callback) {
        $.ajax({
            type: 'POST',
            url: this.url.upload_xls_result_table,
            data: form_data,
            contentType: false,
            cache: false,
            processData: false,
